...
public class DtmConst {
    ...
    public static class InitSql {
        ...
        public static final String INSERT_SQL = "insert into account VALUES (?, 0, ?);";
    ...
    public static class TransferSql {
        ...
        //记录流水
        public static final String TRANSFER_INSERT_TRANSACTION
            = "insert into account_transaction(tx_id,user_id,money,type) values( ?,?,?,?) ";
    }
